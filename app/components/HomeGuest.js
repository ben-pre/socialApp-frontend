	...
	function myReducer(draft, action) {
		switch (action.type) {
			...
			case "usernameAfterDelay":
				...
				if (!draft.hasErrors && !action.noReq) {
			...
			<div className="row align-items-center">
				<div className="col-lg-7 py-3 py-md-5">
					...
					<p className="lead text-muted text-justify">
						Are you sick of short, similar and impersonal post? We believe
						getting back to actually writing is the key to enjoy the internet
						again. Join thousands of others and share your most interesting
						stories.
					</p>
				</div>
